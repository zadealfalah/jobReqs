...
export DATASET_LOC="https://raw.githubusercontent.com/zadealfalah/jobReqs/classifier_model/datasets/dataset.csv"
...
export HOLDOUT_LOC="https://raw.githubusercontent.com/zadealfalah/jobReqs/classifier_model/datasets/holdout.csv"
...
aws s3 cp $MODEL_REGISTRY # Update with final s3 bucket location for model
aws s3 cp results/ # Update with final s3 bucket location for results