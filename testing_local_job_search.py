...
from package.python.utils import get_url, get_job_ids, get_job_data, k
...
try:
    driver_list = [webdriver.Chrome(options=options) for x in range(0, max_threads)] # create max_threads num of drivers
